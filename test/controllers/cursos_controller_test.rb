...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { descricao: @curso.descricao, professor_id: @curso.professor_id, titulo: @curso.titulo, videoIntro: @curso.videoIntro } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { descricao: @curso.descricao, professor_id: @curso.professor_id, titulo: @curso.titulo, videoIntro: @curso.videoIntro } }
