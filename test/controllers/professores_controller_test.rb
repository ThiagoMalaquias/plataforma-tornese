...
class ProfessoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professores_url, params: { professor: { foto: @professor.foto, nome: @professor.nome, sobre: @professor.sobre } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { foto: @professor.foto, nome: @professor.nome, sobre: @professor.sobre } }
