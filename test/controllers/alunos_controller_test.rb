...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cpf: @aluno.cpf, data_nascimento: @aluno.data_nascimento, email: @aluno.email, nome: @aluno.nome, senha: @aluno.senha, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cpf: @aluno.cpf, data_nascimento: @aluno.data_nascimento, email: @aluno.email, nome: @aluno.nome, senha: @aluno.senha, telefone: @aluno.telefone } }
